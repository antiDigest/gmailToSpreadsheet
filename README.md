...
Setting up a modern development environment for building [Google Apps Script](https://www.AntiDigest.org/topic/google-apps-script/) projects is easy and quick (**[video tutorial](https://www.youtube.com/watch?v=KxdCIbeO4Uk)**).
...
```
git clone https://github.com/AntiDigest/gmailToSpreadsheet my-project
cd my-project
npm install
```
...
```
npx degit AntiDigest/gmailToSpreadsheet my-project
```
...
Contributions and feature requests are welcome. If you are using the package and fixed a bug for yourself, please consider submitting a PR!

### :lock: License

[MIT License](https://github.com/AntiDigest/gmailToSpreadsheet/blob/master/LICENSE) (c) AntiDigest
